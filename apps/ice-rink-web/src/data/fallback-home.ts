    ...
    ContentBlocks: [
      {
        ...
        content: {
          type: 'Main',
          eyebrow: '{{service}}',
          headline: 'Portable Ice Rink Rentals for Events',
          ...
          trustLine: 'Event-ready portable rink planning with setup guidance and quote support',
        },
      },
      {
        type: 'TrustBar',
      ...
      },
      {
        ...
        content: {
          ...
          secondaryLinkText: 'View service-area planning',
