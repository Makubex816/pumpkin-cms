            ...
            <table className="min-w-full divide-y divide-neutral-200">
              ...
              <tbody className="divide-y divide-neutral-200">
                {filtered.map((definition) => (
                  <tr key={getFormDefinitionId(definition)} className="hover:bg-neutral-50">
                    <td className="px-4 py-3">
                      <Link
                        href={`/admin/forms/${encodeURIComponent(getFormDefinitionId(definition))}`}
...
function getFormDefinitionId(definition: FormDefinition) {
  return definition.formDefinitionId || definition.id || definition.formKey || 'unknown-form';
}
