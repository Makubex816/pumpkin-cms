...
| Multi-Tenant Onboarding import package governance implementation | `deployment/architecture/multi-tenant-onboarding/import-package-governance-implementation/` | V2.11.5 / L01 / L06 / L07 / L10 / L12 / L13 / L14 | Current local no-write validator, builder, preview CLI, contract fixtures/checks, ignored `.tmp` evidence, and tests |
| Import Intake GET-only Pumpkin API endpoint service | `apps/pumpkin-api/Services/ImportIntake/` | V2.11.5 / L04 / L10 / L12 / L13 / L14 | Current local/read-only fixture-backed import-intake API endpoint foundation; V2.11.5 signoff passed source/build/test scans |
| Import Intake Admin route | `apps/admin/src/app/dashboard/import-intake/page.tsx` | V2.11.5 / L03 / L04 / L13 / L14 | Current local/read-only Admin import-intake preview route; V2.11.5 type-check and QA passed |
| Import Intake Admin API bridge provider | `apps/admin/src/lib/import-intake/api-provider.ts` | V2.11.5 / L03 / L04 / L12 / L13 / L14 | Current Admin GET-only import-intake API bridge provider with fixture fallback |
| Import Intake Admin QA script | `apps/admin/scripts/v2-11-4-import-intake-readonly-check.mjs` | V2.11.5 / L03 / L10 / L12 / L13 / L14 | Current scoped Admin import-intake read-only QA |
