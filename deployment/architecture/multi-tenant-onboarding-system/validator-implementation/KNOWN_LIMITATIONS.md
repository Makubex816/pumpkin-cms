...
- Media and form reference validation use documented field-name conventions such as `mediaId`, `formId`, `staticEndpointRef`, `leadRecipientRef`, and legacy `recipientGroup`; they do not understand every future custom block shape yet.
