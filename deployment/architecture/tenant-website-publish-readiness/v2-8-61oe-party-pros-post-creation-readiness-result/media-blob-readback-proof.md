...
Fresh readback confirmed the existing Party Pros media container state.
...
Readback used Azure CLI storage blob listing with Azure AD auth mode. No storage keys, listKeys, or SAS were used.
