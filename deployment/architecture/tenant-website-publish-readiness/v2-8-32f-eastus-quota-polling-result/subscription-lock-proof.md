...
Every future Pumpkin API Azure resource must remain under:

`/subscriptions/ff887def-fd83-4a19-9298-13d4b1687873/`

## Commands

The subscription was set before read-only Azure metadata checks:
...
Subscription lock passed. No Azure mutation occurred.
