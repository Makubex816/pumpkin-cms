...
Pumpkin API health returned `providerConfigured:false`; authenticated Admin/API read proof still succeeded.

No deploy, contact POST, form submission, DNS/indexing, or production cutover occurred.
