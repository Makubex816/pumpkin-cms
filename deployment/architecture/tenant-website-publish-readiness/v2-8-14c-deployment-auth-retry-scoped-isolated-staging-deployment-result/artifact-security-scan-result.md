...
The fresh sanitized artifact was scanned by path-only reporting for high-confidence secret-like content, forbidden config paths, required files, and localhost references.
