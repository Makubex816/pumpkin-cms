...
`apps/ice-rink-web/.tmp/v2-8-26-production-swa-package/package_20260626142333/app/contact/index.html`
...
Conclusion: the static contact page remained wired to the same-origin SWA managed API path and retained the approved public contact email.
