...
| --- | --- |
| Current V2 reference | V2.8.14B, Scoped Ice Isolated Staging Deployment Execution |
| Current V2 status | Complete; isolated target, tooling, and artifact gates pass, but deployment stopped before execution because `SWA_CLI_DEPLOYMENT_TOKEN` is absent |
