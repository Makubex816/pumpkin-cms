...
| --- | --- |
| Current V2 reference | V2.8.14, Scoped Ice Staging Publish Execution Approval |
| Current V2 status | Complete blocked-before-deployment result; local artifact and validators pass, but deployment stopped because the target has production custom domains attached and deployment auth/tooling is not ready |
